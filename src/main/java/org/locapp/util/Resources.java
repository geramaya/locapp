...
public class Resources {
     ...
     * Konfigurationsdatei. Der Name der Konfigurationsdatei ist abh�ngig von
     * der Anwendungsumgebung.
     */
    private static void initializeResources() {
        try {
            resources = new Resources();
            String environmentSetting = System.getProperty("org.locapp.env");
